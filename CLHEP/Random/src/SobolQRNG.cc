...
SobolQRNG::SobolQRNG(int dimension)     	// 15 Feb. 1998  JMM
{
...
double SobolQRNG::flat()
{
   ...
   */
   return currentVector[currentIndex++];
}

void SobolQRNG::flatArray(const int size, double* vect)
{
//   double uni;
   int i;
